...
int main(){
    ...
    int n,m,a,b,ii,jj,u,v,w;
    cin>>n;
    for (int i=0;i<n-1;i++) {
        cin>>u>>v>>w;       
        ptr[u]->edge.push_back({ptr[v], w});
        ptr[v]->edge.push_back({ptr[u], w});
    }
